...
git push origin master
        ...
        <section id="terminology">
          <div className="container">
            ...
            <p>
              Поработав некоторое время в айти сфере так и хочет юзать (но вот опять) словечки, которые просто вьедаются в разум за счет частого использования английских слов в сочетании с техническими понятиями.
            </p>
